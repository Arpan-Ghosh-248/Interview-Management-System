...
CREATE TABLE `newcandidates` (
  ...
  `candEmail` varchar(150) NOT NULL,
  `Media` varchar(150) NOT NULL,
  `Appliedfor` int(10) DEFAULT NULL,
  `candQuali` varchar(150) NOT NULL,
  `CallingPerson` varchar(150) NOT NULL,
  `modeofinterview` varchar(150) NOT NULL,
   `interviewscheduleddate` varchar(150) NOT NULL,
   `time` varchar(150) NOT NULL,
 `Result` varchar(150) NOT NULL,
 `InterviewScheduledBy` varchar(150) NOT NULL,
